...
########################################################################################################################
# This file was copied from https://github.com/ClementPinard/FlowNetPytorch
########################################################################################################################
...
class StaticCrop(object):
    """ Crops the frame at the given coordinates """
    ...
    def __init__(self, position, size):
        ...
        if isinstance(position, numbers.Number):
            self.position = (int(position), int(position))
        else:
    ...
    def __call__(self, inputs, target):
        ...
        inputs[0] = inputs[0][pos_y: pos_y + th, pos_x: pos_x + tw]
        inputs[1] = inputs[1][pos_y: pos_y + th, pos_x: pos_x + tw]
        return inputs, target[pos_y: pos_y + th, pos_x: pos_x + tw]
